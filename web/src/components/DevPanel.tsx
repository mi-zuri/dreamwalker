...
import { forceError } from '../mocks/api';
...
/**
 * Phase 1 only: jump to any screen and arm the next mock call to fail, so every
 * state in the plan's screen list is reachable without a backend.
 */
