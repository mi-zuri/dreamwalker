 ...
 * One `language` setting drives these and the story both.
 */
const STRINGS = {
  en: {
    ...
    storiesTitle: "-- WHAT HAPPENED --",
    storiesHint: "pick one to live through",
    storiesLoading: "reading the news...",
    storiesEmpty: "nothing new to play right now. come back later.",
    storiesBack: "[BACK]",
    storyNote: "content note",
    freshnessFresh: "today",
    freshnessAging: "this week",
    freshnessStale: "older",
  ...
  pl: {
    ...
    ideaPlaceholder: "wyszeptaj to gwiazdom...",
    ...
    storiesTitle: "-- CO SIĘ WYDARZYŁO --",
    storiesHint: "wybierz jedno, by to przeżyć",
    storiesLoading: "czytam wiadomości...",
    storiesEmpty: "na razie nie ma nic nowego. zajrzyj później.",
    storiesBack: "[WSTECZ]",
    storyNote: "uwaga",
    freshnessFresh: "dzisiaj",
    freshnessAging: "w tym tygodniu",
    freshnessStale: "starsze",
